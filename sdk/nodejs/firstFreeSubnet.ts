...
export class FirstFreeSubnet extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FirstFreeSubnetArgs | FirstFreeSubnetState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            if (!args || args.parentSubnetId === undefined) {
            ...
            inputs["parentSubnetId"] = args ? args.parentSubnetId : undefined;
            ...
            inputs["subnetAddress"] = undefined /*out*/;
        ...
        super(FirstFreeSubnet.__pulumiType, name, inputs, opts);
    }
}
