...
class Address(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 remove_dns_on_delete: Optional[pulumi.Input[bool]] = None,
        ...
        if opts.id is None:
            ...
            __props__['remove_dns_on_delete'] = remove_dns_on_delete
    ...
    def get(resource_name: str,
            ...
            state_tag_id: Optional[pulumi.Input[int]] = None,
            subnet_id: Optional[pulumi.Input[int]] = None,
            switch_port_label: Optional[pulumi.Input[str]] = None) -> 'Address':
        """
    ...
    @property
    @pulumi.getter(name="removeDnsOnDelete")
    def remove_dns_on_delete(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "remove_dns_on_delete")
